  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground shadow-premium",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-premium",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        premium: "bg-gradient-premium text-white hover:shadow-premium-lg hover:scale-[1.02] font-semibold",
        glass: "glass text-foreground hover:shadow-premium-lg hover:scale-[1.02] backdrop-blur-xl",
        hero: "bg-gradient-premium text-white hover:shadow-premium-lg hover:scale-[1.02] font-semibold",
        glow: "glass text-foreground hover:shadow-premium-lg hover:scale-[1.02] backdrop-blur-xl border border-primary/20",
      },
      size: {
