const Footer = () => {
  return (
    <footer className="bg-hero-bg text-white py-20">
      <div className="container mx-auto px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-white/70 text-lg font-light leading-relaxed max-w-md">
              AI For the rest of us. The platform that allows ANYONE to go from idea to enterprise leveraging the power of AI.
            </p>
          ...
          <div className="space-y-6">
            <h4 className="font-semibold text-white text-lg tracking-tight">Product</h4>
            <ul className="space-y-3 text-white/70">
              <li><a href="#" className="hover:text-white transition-colors font-light">Features</a></li>
              <li><a href="#" className="hover:text-white transition-colors font-light">Pricing</a></li>
          ...
          <div className="space-y-6">
            <h4 className="font-semibold text-white text-lg tracking-tight">Company</h4>
            <ul className="space-y-3 text-white/70">
        ...
        <div className="border-t border-white/20 pt-8 text-center text-white/60 font-light">
          <p>&copy; 2024 Jarvis. All rights reserved. AI For the rest of us.</p>
        </div>
      </div>
    </footer>
  );
